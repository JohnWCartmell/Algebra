<xsl:transform version="2.0" 
	...
	<xsl:include href="qstar2number.module.xslt"/>
	<xsl:include href="qstar2txt.module.xslt" />
	<xsl:include href="qstar2tex.module.xslt" />
	<xsl:include href="qstar2type_enrichment.module.xslt" />
	<xsl:include href="qstar.naming.module.xslt" />
	...
	<xsl:include href="../../algebraLibrary/gat.structured_text.module.xslt"/> 
