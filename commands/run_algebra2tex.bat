...
java -jar %SAXON_PATH%\saxon9he.jar -s:%THEORY%/theory/temp/algebra.enriched.xml -xsl:%THEORY%/theory/main_type_enrichment.xslt -o:%THEORY%/theory/temp/algebra.type_enriched.xml
